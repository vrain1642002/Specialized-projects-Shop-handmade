...
export class OrderComponent implements OnInit {
  ...
  orderData: OrderDTO = {
    Ma_Nguoidung: 0, // Thay bằng user_id thích hợp
    ...
    Phuongthucvanchuyen: 'express',
    trangthai:true,
    trangthaiDH:"", // Mặc định là vận chuyển nhanh (Express)
  ...
  ngOnInit(): void {
    ...
    if (userDataString) {
      ...
      const maValue = userData.ma;
      this.orderData.Ma_Nguoidung=maValue;
      alert(maValue);
    } else {
     return;
    }
